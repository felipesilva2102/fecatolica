...
@Getter
@Setter
public class NovenaSantoAntaoBean implements Serializable {

    private static final long serialVersionUID = 1L;

    private String nome = "Novena a Santo Antão";

    private String periodo = "Normalmente feita dos dias 08 de Janeiro à 16 de Janeiro.";

    private String historia = "Santo Antão, o Grande, nasceu no Egito em 251 e renunciou à riqueza para viver como eremita no deserto, dedicando-se à oração e penitência. Venceu heroicamente as tentações do demônio e tornou-se líder espiritual dos cenobitas na Tebaida. Durante perseguições, confortou os cristãos e, já idoso, visitou São Paulo, o eremita. Morreu aos 105 anos, em 17 de janeiro de 356, deixando um legado de santidade e sabedoria. Suas relíquias repousam na igreja de St. Julien, em Arles, e é representado com um porco, símbolo de sua vitória contra o mal.";

    private String oracaoInicial = "Ó Santo Antão, vós que por sua oração vencestes o demônio, rogai ao Divino Pai Eterno para que Ele nos envie o Espírito Santo que Jesus falou no Evangelho para que, como vós, também possamos ser fortes na hora da tentação. Socorrei-nos Santo Antão. Amém.\n"
            + "\n"
            + "Faça seu pedido a Deus por intercessão de Santo Antão.\n"
            + "\n"
            + "Pai Nosso, Ave Maria, Glória ao Pai.";

    private String oracaoFinal = "Ó Deus, que permitistes que, mesmo na solidão de uma gruta, no deserto, o demónio perturbasse Santo Antão com violentas tentações, mas lhe destes força de vencê-las, enviai-me, do céu, o Vosso socorro, porque eu vivo num ambiente minado de tentações que me agridem, pelo celular, rádio, televisão, novelas, bailes, cinemas, revistas, propagandas e maus companheiros.\n"
    ...
    private String terceiroDia = "“Nada mais útil pode ser ao Cristão do que pensar todos os dias: Estou começando a servir a Deus e o dia de hoje pode ser o meu último” – Santo Antão.\n"
            + "\n"
    ...
    private String quintoDia = "Dois dos irmãos da ordem de Santo Antão estavam em viagem para vê-lo, e no caminho a água acabou. Um morreu e o outro estava a ponto de morrer. Já não tinha forças para andar, mas jazia no chão esperando também a morte. Sentado na montanha, Antão chamou dois monges que casualmente estavam ali e os compeliu a se apressarem:\n"
            + "\n"
    ...
    private String disponivel = "https://rumoasantidade.com.br/novena-a-santo-antao/?srsltid=AfmBOoqGs2PbNOcmGnswloAUyDb2Hfly4ugo4_b536EHN6nbzTc3uIBM";
}
