...
public class NovenaSantoAntonioSantanaGalvaoBean implements Serializable {
    ...
    private String primeiroDia = "Frei Galvão foi o primeiro santo brasileiro. Foi Canonizado pelo Papa Bento XVI, durante sua visita ao Brasil, em 11 de maio de 2007. As pílulas de Frei Galvão, pequeninos papeis, escritos com versículos da Bíblia, dobrados e ingeridos pelos fiéis, realizaram vários milagres em seus seguidores. Frei Galvão nasceu em Guaratinguetá, no interior do Estado de S. Paulo. Filho de Antônio Galvão de França, Capitão-mor, pertencia a Ordem Terceira de São Francisco e a Ordem do Carmo. Se dedicava ao comércio e era conhecido pela sua particular generosidade. A mãe, Isabel Leite de Barros, teve onze filhos e morreu com apenas 38 anos de idade com fama de grande caridosa.\n"
            + "\n"
            + "Oração do dia\n"
