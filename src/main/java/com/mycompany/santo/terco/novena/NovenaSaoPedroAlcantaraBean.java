...
@Getter
@Setter
public class NovenaSaoPedroAlcantaraBean implements Serializable {
    ...
    private String primeiroDia = "Glorioso São Pedro de Alcântara, que, sentindo, em vossa alma, uma grande fome de céu, soubeste renunciar a todas as riquezas e prazeres do mundo: dai-nos força e decisão para apartar de nós tudo quanto impede nossa futura salvação. Amém.\n";

    private String segundoDia = "Admirável São Pedro de Alcântara, que, esforçando-vos dia após dia, fostes lavrando, em vossa alma, a efigie de uma grande santidade: ensinai-nos a sermos verdadeiros santos, levando uma vida fervorosa e sem mancha. Amém.\n";

    private String terceiroDia = "Penitentíssimo São Pedro de Alcântara, vós, que tiveste sempre a convicção de que, sem mortificação, ninguém se vê livre de pecados; esforça nosso ânimo, para que consigamos imitar vossos rigores e penitencias. Amém.\n";

    private String quartoDia = "Piedosíssimo São Pedro de Alcântara, cujos fervores na oração vos arrastaram centenas de vezes ao êxtase e aos arrebatamentos: aquece nossa alma em vosso fervor e ajudai-nos na fidelidade a Deus. Amém.\n";

    private String quintoDia = "Caridoso São Pedro de Alcântara, tão solicito sempre pelas necessidades do corpo e alma de vossos próximos; fazei-nos ver que, sem caridade, não seremos discípulos de Cristo nem poderemos entrar no céu. Amém.\n";

    private String sextoDia = "Santo benfeitor, São Pedro de Alcântara, que iniciastes a grande Reforma da Ordem Franciscana começando por reformar a fundo a própria vida: fazei que examinemos nossa consciência, para começar ali a reforma que ansiamos ver no mundo. Amém.\n";

    private String setimoDia = "Fervoroso São Pedro de Alcântara, que entraste como franciscano em um convento colocando sob o patrocínio da Santa Mãe de Deus, e designaste com títulos marianos os conventos por vós fundados: Contagiai-nos vosso filial e decisivo amor a Virgem, nossa Mãe. Amém.\n";
