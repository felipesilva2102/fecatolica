...
@Getter
@Setter
public class NovenaSaoJoaoPauloBean implements Serializable {
    ...
    private String primeiroDia = "o Amor\n"
    ...
    private String segundoDia = "a Verdade\n"
    ...
    private String terceiroDia = "a pessoa\n"
            ...
            + "\n"
            + "“Deus, de fato, amou de tal modo o mundo, que lhe deu o seu filho unigênito, para que todo o que nele crer não pereça, mas tenha a vida eterna” (Jó 3:16) (…). E por meio do Filho-Verbo, que se fez homem, (…) Deus entrou na história da humanidade (…) um dos milhares de milhões e, ao mesmo tempo, Único!\n"
            + "\n"
            + "Para Ele queremos olhar, porque só nele, Filho de Deus, está a salvação, renovando a afirmação de Pedro: “Senhor, para quem havemos nós de ir? Tu tens palavras de vida eterna” (Jó 6:69). (…). Através de todos os campos de atividade onde a Igreja se afirma presente, se encontra e se consolida, devemos tender constantemente para Aquele “que é a Cabeça”, para “aquele, para quem e por quem são todas as coisas [criadas]”. (Hb 2:10)\n"
            + "\n"
    ...
    private String quartoDia = "a família\n"
    ...
    private String quintoDia = "a juventude\n"
            ...
            + "\n"
            + "São João Paulo II, Homilia para a conclusão VI / DM,\n"
            + "Częstochowa, 15 de agosto de 1991.\n"
            + "\n"
    ...
    private String sextoDia = "o pecado\n"
            ...
            + "\n"
            + "João Paulo II,\n"
            + "Angelus, em Roma, 23 de fevereiro de 1986.\n"
            + "\n"
    ...
    private String setimoDia = "a misericórdia\n"
            ...
            + "\n"
            + "João Paulo II, Exortação Apostólica Reconciliatio\n"
            + "et Paenitentia, 2 de dezembro de 1984.\n"
            + "\n"
    ...
    private String oitavoDia = "Virgem Maria\n"
            + "Em meio a este mistério, em meio a essa confiança na fé, destaca Maria: “Eis aqui a serva do Senhor, faça-se em mim a tua palavra”. (Lc 1:38)\n"
            + "\n"
            + "Hoje vim junto de ti, Nossa Senhora de Jasna Góra, para me despedir mais uma vez e para te pedir a bênção para a minha viagem (…) Mãe da Igreja! Mais uma vez me consagro a ti “na tua materna escravidão de amor”: Totus Tuus! Sou todo teu! Consagro-te toda a Igreja – em toda a parte até aos extremos confins da Terra! Oh, consagro-te a humanidade! Eu te consagro todos os homens,\n"
            + "meus irmãos.\n"
            + "\n"
            ...
            + "\n"
            + "João Paulo II,\n"
            + "Primeira Peregrinação Apostólica à Polônia,\n"
            + "Częstochowa, 6 de junho de 1979.\n"
            + "\n"
            + "Oremos: Deus, nosso Pai, Maria, Mãe de vosso Filho, escutai a nossa prece e petição: “Advogada nossa, estes vossos olhos misericordiosos a nós volvei, e depois deste desterro, mostrai-nos Jesus, bendito fruto do vosso ventre. Ó clemente, ó piedosa, ó doce sempre Virgem Maria!”. Damos graças pelo Santo Papa João Paulo II, totalmente dedicado a Maria, com fidelidade e até o final cumprindo a missão que lhe foi dada pelo Ressuscitado; aceitai os frutos de sua vida e serviço, concedendo-nos por sua intercessão\n"
            + "esta graça (fazer pedido) Por Cristo, Nosso Senhor. Amém.\n"
            + "\n"
            + "Pai Nosso, Ave Maria, Glória e Ladainha.";

    private String nonoDia = "a Eucaristia\n"
