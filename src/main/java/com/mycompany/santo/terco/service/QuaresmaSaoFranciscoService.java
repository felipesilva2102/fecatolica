...
public class QuaresmaSaoFranciscoService {
    ...
    private static final String PREPARACAO_DIARIA = """
            ...
            • Entre em silencio diante do Crucifixo.""";

    private static final String ORACAO_PAZ = """
            Senhor, fazei de mim um instrumento da Vossa paz.
            Onde houver odio, que eu leve o amor.
            Onde houver ofensa, que eu leve o perdao.
            Onde houver discordia, que eu leve a uniao.
            Onde houver duvida, que eu leve a fe.
            Onde houver erro, que eu leve a verdade.
            Onde houver desespero, que eu leve a esperanca.
            ...
            e e morrendo que se vive para a vida eterna. Amem.""";

    private static final String CANTICO_CRIATURAS = """
            Altissimo, onipotente, bom Senhor,
            a Vos o louvor, a gloria, a honra e toda bencao.
            ...
            que no ceu formastes, claras e preciosas e belas.
            Louvado sejais, meu Senhor, pelo Irmao Vento,
            pelo ar e nuvens, pelo ceu sereno e todo o tempo.
            ...
            Louvado sejais, meu Senhor, pela nossa Irma, a Mae Terra,
            ...
            Louvai e bendizei ao meu Senhor, e dai-Lhe gracas,
            e servi-O com grande humildade. Amem.""";

    private static final String ORACAO_CRUCIFIXO = """
            Altissimo e glorioso Deus,
            iluminai as trevas do meu coracao
            e dai-me a fe reta, a esperanca certa
            e a caridade perfeita,
            senso e conhecimento, Senhor,
            para que eu cumpra a Vossa santa e veridica vontade. Amem.
            (Oracao de Sao Francisco diante do Crucifixo de Sao Damiao)""";

    private static final String BENCAO_FRANCISCO = """
            O Senhor te abencoe e te guarde.
            Mostre-te a Sua face e tenha misericordia de ti.
            Volte para ti o Seu olhar e te de a paz.
            O Senhor te abencoe!
            (Bencao de Sao Francisco a Frei Leao)""";

    private static final String ORACAO_FINAL = """
            O glorioso Sao Francisco, que durante toda a vossa vida amastes a pobreza,
            a humildade e a simplicidade, obtende-nos a graca de seguir os passos de Cristo
            com a mesma alegria e desapego. Fazei que amemos a natureza como irma
            e que nos tornemos instrumentos da paz de Deus no mundo. Amem.""";
    ...
    private static final List<String> LEITURAS = List.of(
            ...
            "Dia 2 - Mateus 5,3: Bem-aventurados os pobres de espirito.",
            "Dia 3 - Mateus 6,19-21: Nao acumuleis tesouros na terra.",
            "Dia 4 - Mateus 10,7-10: De graca recebestes, de graca dai.",
            ...
            "Dia 8 - Lucas 10,1-9: Nao leveis bolsa, nem saco, nem sandalias.",
            "Dia 9 - Lucas 12,22-31: Olhai os lirios do campo.",
            "Dia 10 - Lucas 14,33: Quem nao renuncia a tudo nao pode ser meu discipulo.",
            "Dia 11 - Joao 12,24-26: Se o grao de trigo nao morrer...",
            "Dia 12 - Joao 13,12-17: Dei-vos o exemplo para que facais como Eu fiz.",
            ...
            "Dia 17 - Galatas 6,14: Quanto a mim, gloriar-me-ei na Cruz.",
            "Dia 18 - Filipenses 2,5-11: Humilhou-se, fazendo-se obediente ate a morte.",
            ...
            "Dia 22 - Tiago 2,5: Deus escolheu os pobres para serem ricos na fe.",
            ...
            "Dia 25 - Salmo 104,24: Quao numerosas sao as Vossas obras, Senhor!",
            "Dia 26 - Salmo 8,4-10: Que e o homem para dele Vos lembrardes?",
            "Dia 27 - Salmo 19,2-5: Os ceus proclamam a gloria de Deus.",
            "Dia 28 - Salmo 148: Louvai ao Senhor, sol e lua; louvai-O, astros de luz.",
            "Dia 29 - Eclesiastes 3,1-8: Para tudo ha um tempo debaixo do ceu.",
            "Dia 30 - Isaias 11,6-8: O lobo habitara com o cordeiro.",
            "Dia 31 - Isaias 58,6-9: O jejum que agrada a Deus.",
            "Dia 32 - Isaias 61,1-3: Enviou-me para anunciar a boa nova aos pobres.",
            "Dia 33 - Miquéias 6,8: O que o Senhor te pede: praticar a justica.",
            ...
            "Dia 39 - Joao 15,12-17: Ninguem tem maior amor do que aquele que da a vida.",
            "Dia 40 - Apocalipse 21,1-4: Vi um novo ceu e uma nova terra."
    );
    ...
    public Map<String, Object> getDadosQuaresma(LocalDate data) {
        ...
        if (!dentro) {
            result.put("mensagemDia", "A data selecionada nao esta dentro da Quaresma de Sao Francisco (26/08 - 04/10).");
        } else {
            result.put("mensagemDia", "Dia " + dia + " da Quaresma de Sao Francisco de Assis");
        }
